export const UserCard = ({ avatar, followers, following, tweets }) => {
  return (
    <div className="w-[380px] px-[36px] pb-[36px] pt-[20px] flex flex-col items-center bg-main rounded-[12px] bg-customgradient shadow-shadowCard">
      <svg
      ...
      <p className="mt-[62px]">{tweets} Tweets</p>
      <p className="mt-[16px]">{followers} Followers</p>
      <button className="mt-[26px] w-[196px] px-[28px] py-[14px] bg-secondary shadow-shadowButton rounded-[10px] text-[#373737] text-[18px] font-semibold">
